...
public class ObjectFactory {
     ...
     * 
     */
    @XmlElementDecl(name = "SampleTypes")
    public JAXBElement<Samples.Sample.SampleTypes> createSamplesSampleSampleTypes(Samples.Sample.SampleTypes value) {
        return new JAXBElement<Samples.Sample.SampleTypes>(new QName("http://igsn.org/schema/kernel-v.1.0", "SampleTypes"),Samples.Sample.SampleTypes.class,value);
    }
